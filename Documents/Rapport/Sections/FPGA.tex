\section{FPGA}
FPGA'en fungerer som en del af den hardware der styrer pan/tilt-systemet. FPGA'ens opgaver er bl.a. dataopsamling fra hall sensorene på motorerne.

\subsection{Intern kommunikation}
I forbindelse med at FPGA'en internt er opdelt i flere individuelle moduler. Så kræves det at der udvikles en form for kommunikation mellem disse moduler. Der er flere bud på ,hvordan dette kan foregå og i de følgende afsnit vil fordele og ulemper ved de forskellige metoder blive beskrevet.

\subsubsection{Signalering til master controller}

\subsubsection{Intern databus med addressering}

\paragraph*{Intern RAM blok med specificerede addresser}

\paragraph*{Et datasæt per addresseXXXX}
...
\subsection{SPI}
Der skal foregå en kommunikation mellem microcontrolleren og FPGA'en. Til dette formål er der i opgaven specificieret at grænsefladenXXXX SPI skal bruges. GrænsefladenXXXXs overordnede virkemåde er beskrevet nærmere i afsnit \ref{subsec:SPI}. I dette afsnit vil der blive beskrevet fordele og ulemper ved forskellige måder at implementerer denne grænseflade i FPGA'en. Dernæst vil der blive foretaget en dybere gennemgang af den valgte implementation. Og konkluderes på, hvordan denne implementation har fungeret rent praktisk.
\subsubsection{Implementationer}

\paragraph{XXXX8-bit pakker med kommunikationsprotokol}

\paragraph{XXXX16-bit pakker med 4-bit addressering}
...
\subsubsection{ToggleXXXXBrugForUnderscoreButton3}

\subsection{Overordnede System XXXX}