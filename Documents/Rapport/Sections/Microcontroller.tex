...
\begin{subfigure}[t]{0.3\textwidth}
	\includegraphics[width=1\textwidth]{Billeder/Taskdiagram1.png}
    ...
    \end{subfigure}
    \begin{subfigure}[t]{0.3\textwidth}
\includegraphics[width=1\textwidth]{Billeder/Taskdiagram2.png}
	\caption{Task diagrammet over UART receive. Informationen gemmes i Shared State Memory.}
	\label{fig:task2}
    \end{subfigure}
    \begin{subfigure}[t]{0.3\textwidth}
	\includegraphics[width=1\textwidth]{Billeder/Taskdiagram3.png}
