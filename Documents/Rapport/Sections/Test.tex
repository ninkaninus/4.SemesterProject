...
Da det er meget vigitigt at have et rubust kontrol system der er skræddersyet til vores system er det stærkt nødvendigt at teste vores system på alle de punkter der kan have inflydelse på denne. Da der er en lang række faktorer der skal være med i modellen for at kontrol systemet kan opfører sig som forventet, og den simpleste metode at tage højde for disse er at måle deres inflydelse, og så eventuelt justerer dem hvis dette er muligt.
